...
useHead({
  ...
  meta: [
     { name: 'description', content: seo.value.meta_description || '' },
      ...
      { name: 'twitter:title', content: seo.value.twitter_title || '' },
      { name: 'twitter:description', content: seo.value.twitter_description || '' },
      { name: 'twitter:image', content: seo.value.twitter_image || '' },
      { name: 'twitter:site', content: seo.value.twitter_site || '' },
      { name: 'twitter:creator', content: seo.value.twitter_creator || '' },
  ],
  link: [
